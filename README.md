...
```bash
make test EP=EP0 CPNT=alu VISUAL=1
```
O componente `alu` será testado com a testbench `alu_tb` e o GtkWave será aberto para visualizar o resultado da simulação.
